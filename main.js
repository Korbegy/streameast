...
if(page=="page6"){window.location='https://dwnlds.co/9a87959';}}
...
var questions=[new Question("هل انت مستعد للعمل لمدة 6 ساعات يوميا ؟",["نعم","لأ"]),new Question("ما هو مستواك التعليمي",["جامعي","استطيع القراءة والكتابة"]),new Question("اختر احدى المجالات التالية التي تناسب هوايتك او تخصصك ؟",["تسويق الالكتروني","كتابة مقالات","مراقب كاميرات مراقبة","خدمة العملاء","سائق و توصيل","وظيفة اخري"])];function Quiz(questions){this.questions=questions;this.questionIndex=0;}
